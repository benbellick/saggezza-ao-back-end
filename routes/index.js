...
const allowImportAgain = require(`../controllers/allowImportAgain`);
const removeDeletedCandFromDb = require(`../controllers/removeDeletedCandFromDb`);
const updateCompleteness = require(`../controllers/updateCompleteness`);
...
module.exports = function (app, db) {
    ...
    app.post(`/ping-admin`, auth, isAdmin, (req, res) => {
        sendResponse(res, `Valid Token!`);
    });
     ...
     */
    app.post(`/create-candidate`, auth, (req, res) => {
    ...
    app.post(`/remove-deleted-cand-from-db`, auth, isAdmin, (req, res) => {
        removeDeletedCandFromDb(req, db).then((response) => {
            sendResponse(res, response);
        });
    });
     ...
     */
    app.post(`/get-all-users`, auth, (req, res) => {
     ...
     */
    app.post(`/import-candidates`, auth, (req, res) => {
     ...
     */
    app.post(`/search-candidate`, auth, (req, res) => {
     ...
     */
    app.post(`/switch-status`, auth, (req, res) => {
        changeChecklist(req, db).then((response) => {
            sendResponse(res, response);
        });
    });

    app.post(`/update-completeness`, auth, (req, res) => {
        updateCompleteness(req, db).then((response) => {
            sendResponse(res, response);
        });
    ...
    app.post(`/return-checklist`, auth, (req, res) => {
        getChecklist.returnChecklist(req, db).then((response) => {
            sendResponse(res, response);
        });
    });

    app.post(`/return-checklist-done`, auth, (req, res) => {
        getChecklist.returnChecklistDone(req, db).then((response) => {
            sendResponse(res, response);
        });
    });

    app.post(`/toggle-app-checklist`, auth, (req, res) => {
        changeChecklistApplicability(req, db).then((response) => {
            sendResponse(res, response);
        });
    });

    app.post(`/allow-import-again`, auth, isAdmin, (req, res) => {
        allowImportAgain(req, db).then((response) => {
            sendResponse(res, response);
        });
    });
